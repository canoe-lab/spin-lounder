const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B_WBxjNX.js","assets/index-BVG84B-c.js"])))=>i.map(i=>d[i]);
import{aR as v,aS as C,M as l,l as h,O as f,aT as x,E as S,aU as E,_ as b,C as k,U as A,t as O,m as _,aV as m,R as L,aW as u,i as N,aX as R}from"./index-BVG84B-c.js";const T=v`
  :host {
...
`;var d=function(w,e,t,o){var i=arguments.length,n=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(w,e,t,o);else for(var r=w.length-1;r>=0;r--)(a=w[r])&&(n=(i<3?a(n):i>3?a(e,t,n):a(e,t))||n);return i>3&&n&&Object.defineProperty(e,t,n),n};const y="scroll-lock";let s=class extends C{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=l.state.open,this.caipAddress=h.state.caipAddress,this.isSiweEnabled=f.state.isSiweEnabled,this.connected=h.state.isConnected,this.loading=l.state.loading,this.initializeTheming(),x.prefetch(),this.unsubscribe.push(l.subscribeKey("open",e=>e?this.onOpen():this.onClose()),l.subscribeKey("loading",e=>{this.loading=e,this.onNewAddress(h.state.caipAddress)}),h.subscribeKey("isConnected",e=>this.connected=e),h.subscribeKey("caipAddress",e=>this.onNewAddress(e)),f.subscribeKey("isSiweEnabled",e=>this.isSiweEnabled=e)),S.sendEvent({type:"track",event:"MODAL_LOADED"})}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.open?E`
        ...
        `:null}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){if(this.isSiweEnabled){const{SIWEController:e}=await b(async()=>{const{SIWEController:t}=await import("./index-B_WBxjNX.js");return{SIWEController:t}},__vite__mapDeps([0,1]));e.state.status!=="success"&&this.connected&&await k.disconnect()}l.close()}initializeTheming(){const{themeVariables:e,themeMode:t}=R.state,o=A.getColorTheme(t);O(e,o)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),_.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const e=document.createElement("style");e.dataset.w3m=y,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
